...
static void ES_GEN_WELD_init__(ES_GEN_WELD *data__, BOOL retain)
{
  ...
  __INIT_VAR(data__->USON_STATE,0,retain)
  ...
  ES_PROCESS_REGISTER_IW(ES_AI_USON_STATE);
}
...
static void ES_GEN_WELD_body__(ES_GEN_WELD *data__)
{
  ...
  __SET_VAR(data__->,USON_STATE,,ES_PROCESS_READ_IW(ES_AI_USON_STATE));
