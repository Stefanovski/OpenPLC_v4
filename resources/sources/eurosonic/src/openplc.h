...
#define MAX_DIGITAL_INPUT    2048   // Entspricht PLC_SIZE_BOOL_IN (0x800)
#define MAX_DIGITAL_OUTPUT   2048   // Entspricht PLC_SIZE_BOOL_OUT (0x800)
#define MAX_ANALOG_INPUT     2048   // Entspricht PLC_SIZE_INT_IN (0x800)
#define MAX_ANALOG_OUTPUT    2048   // Entspricht PLC_SIZE_INT_OUT (0x800)
